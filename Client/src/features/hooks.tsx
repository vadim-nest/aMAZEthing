  ...
  switch(step){
    case 1:
      ...
      <>
        ...
        <p>Click <b>next</b> to learn more or <b>skip</b> to start playing</p>
        <img className="tutorial-img" src="./src/assets/tutorial/maze.png"></img>
      </>
      )
      case 2:
      return (
      <>
        ...
        <p>Each animal has different <i>path finding</i> and <i>sorting</i> algorithms. Head to our <a>learning section</a> to find out more </p>
        <img src="./src/assets/tutorial/shop.png"></img> 
        <img className="tutorial-img"src="./src/assets/tutorial/buy-minion.png"></img>
      </>
      )
      case 3:
      return (
      <>
        ...
        <h2>Select an animal with left-click and the destination with a right-click</h2>
        <p>You will see the animal's thought process before they set off</p>
        <img className="tutorial-img" src="./src/assets/tutorial/think-process.gif"></img>
      </>
      )
      case 4:
      return (
      <>
        ...
        <p>Each tower has an unsorted set of numbers. To conquer a tower, send an animal to sort it. </p>
        <p>Once sorted, the animal will return to the home base</p>
          <img className="tutorial-img" src="./src/assets/tutorial/tower-sorting.gif"></img>
      ...
      <>
        ...
        <p>Animals with more advanced path finding algorithms will try to avoid them</p>
        <img className="tutorial-img" src="./src/assets/tutorial/tree-obstacle.gif"></img>
      </>
      )
  }
