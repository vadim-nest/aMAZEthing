    ...
    return (
        <div className='curve'>
          <svg viewBox='-10 4 140 24'>
            ...
            <circle className='circles' id='circle-bubble-sort' onClick={(() => navigate('/learning/BFS'))} cx="10" cy="14.6" r="3" />
            <image className='nuts' x="6.75" y="12" href={theNut} height='6' width='6' />
            <text x="8" y="10" className="lesson-name">BFS</text>

            <circle className='circles' onClick={(() =>navigate('/learning/DFS'))} cx="40" cy="0" r="3" />
            <image className='nuts'  x="36.75" y="-2.75" href={theNut} height='6' width='6' />
            <text x="38" y="-5" className="lesson-name">DFS</text>

            <circle className='circles' onClick={(() =>navigate('/learning/Dijkstra'))} cx="65.2" cy="12.6" r="3" />
            <image className='nuts'  x="62" y="10" href={theNut} height='6' width='6' />
            <text x="62" y="8" className="lesson-name">Dijkstra</text>

            <circle className='circles' onClick={(() =>navigate('/learning/AStar'))} cx="102" cy="6" r="3" />
            <image className='nuts'  x="98.75" y="3.25" href={theNut} height='6' width='6' />
            <text x="101" y="0" className="lesson-name">A*</text>
