...
function Minion({boxSize, minion, setCurrentMinion, setCurrentTile}: {boxSize: number, 
  ...
  return (
    <div onClick={handleClick} onContextMenu={handleContextMenu} className="minion" style={{height: `${boxSize}px`, width: `${boxSize}px`, top: `${boxSize*minion.yPos}px`, left: `${boxSize*minion.xPos}px`}}/>
  )
}
