...
const flag = ({playerClass}: {playerClass: string}) =>
(
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="0 0 511.998 511.998">
<path className={playerClass} d="M82.659,27.601C145.91,27.601,145.91,0,209.16,0c63.254,0,63.254,27.601,126.507,27.601
